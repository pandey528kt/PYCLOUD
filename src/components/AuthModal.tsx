          ...
          <div className="rounded-xl border border-red-900/60 bg-red-950/60 p-3 space-y-2">
            ...
            {(error.includes('authorized') || error.includes('domain') || error.includes('disabled') || error.includes('console')) && (
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 rounded-lg border border-blue-500/30 bg-blue-900/40 py-2 text-xs font-semibold text-blue-200 hover:bg-blue-900/70 transition-all mt-1 shadow-md"
              >
